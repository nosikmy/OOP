...
public class SubstringTest {
    ...
    public void exampleTest1() throws IOException {
        ...
        try (BufferedReader file = new BufferedReader(new InputStreamReader(new FileInputStream("src/test/resources/example1.txt"), UTF_8))) {
    ...
    public void exampleTest2() throws IOException {
        List<Integer[]> ans = new ArrayList<>();
        List<Integer[]> actual = new ArrayList<>();
        try (BufferedReader file = new BufferedReader(new InputStreamReader(new FileInputStream("src/test/resources/example2.txt"), UTF_8))) {
            actual = Substring.searchSubstring(file, "пирог");
        }
        Assertions.assertEquals(ans.size(), actual.size());
        for (int i = 0; i < ans.size(); i++) {
    ...
    public void linesTest() throws IOException {
        ...
        try (BufferedReader file = new BufferedReader(new InputStreamReader(new FileInputStream("src/test/resources/2.txt"), UTF_8))) {
    ...
    public void warAndPeaceTest() throws IOException {
        ...
        try (BufferedReader file = new BufferedReader(new InputStreamReader(new FileInputStream("src/test/resources/WarAndPeace.txt"), UTF_8))) {
    ...
    public void emptyFileTest() throws IOException {
        List<Integer[]> ans = new ArrayList<>();
        List<Integer[]> actual = new ArrayList<>();
        try (BufferedReader file = new BufferedReader(new InputStreamReader(new FileInputStream("src/test/resources/empty.txt"), UTF_8))) {
    ...
    public void bigFileTest() throws IOException {
        ...
        try (BufferedReader file = new BufferedReader(new InputStreamReader(new FileInputStream("src/test/resources/big.txt"), UTF_8))) {
